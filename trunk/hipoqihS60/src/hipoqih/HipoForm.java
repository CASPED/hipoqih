...
public class HipoForm extends Form implements CommandListener
{
     ...
     javax.microedition.lcdui.StringItem strDatoLatitud = new StringItem("StringItem", "N/A", StringItem.PLAIN);
     javax.microedition.lcdui.StringItem strDatoLongitud = new StringItem("StringItem", "N/A", StringItem.PLAIN);
     ...
     javax.microedition.lcdui.StringItem strDatoDeUsuario = new StringItem("StringItem", "N/A", StringItem.PLAIN);
     javax.microedition.lcdui.StringItem strDatoDesde = new StringItem("StringItem", "N/A", StringItem.PLAIN);
     ...
     void ndsInit() throws Exception
     {
          ...
          strDatoDeUsuario.setLayout(Item.LAYOUT_LEFT | Item.LAYOUT_TOP | Item.LAYOUT_2);
          strDatoDeUsuario.setFont(Font.getFont(Font.FACE_SYSTEM, Font.STYLE_PLAIN, Font.SIZE_SMALL));
          strDatoDeUsuario.setPreferredSize(100, -1);
